...
<head>
    ...
    <title>{{ $studentName }} paid for their booking</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 24px;">
                            ...
                            <p style="margin: 0 0 24px; font-size: 15px; line-height: 24px; color: #4b5563;">
                                Hi {{ $tutorFirstName }}, {{ $studentName }} paid for their <strong>{{ $subjectName }}</strong> booking. It's now confirmed on your schedule.
                            </p>
