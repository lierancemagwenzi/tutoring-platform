...
<head>
    ...
    <title>You're approved to teach {{ $subjectName }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 24px;">
                            ...
                            <p style="margin: 0 0 24px; font-size: 15px; line-height: 24px; color: #4b5563;">
                                Hi {{ $firstName }}, your request to teach <strong>{{ $subjectName }}</strong> has been approved. You can now offer services and courses for this subject.
                            </p>
