                    ...
                    <tr>
                        <td style="padding: 40px 40px 24px;">
                            ...
                            <p style="margin: 0 0 24px; font-size: 15px; line-height: 24px; color: #4b5563;">
                                Hi {{ $firstName }}, use the code below to reset your password.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top: 24px;">
                                <tr>
                                    <td style="padding: 16px; background-color: #fef3f2; border: 1px solid #fecdca; border-radius: 8px;">
                                        <p style="margin: 0; font-size: 13px; line-height: 20px; color: #b42318;">
                                            <strong>Security notice:</strong> If you didn't request a password reset, please ignore this email — your password will not be changed. Never share this code with anyone.
                                        </p>
                                    </td>
                                </tr>
                            </table>
