...
<head>
    ...
    <title>You've been invited to administer {{ config('app.name') }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 24px;">
                            <h1 style="margin: 0 0 16px; font-size: 20px; line-height: 28px; color: #111827;">
                                You've been invited to administer {{ config('app.name') }}
                            </h1>
                            <p style="margin: 0 0 24px; font-size: 15px; line-height: 24px; color: #4b5563;">
                                Hi {{ $firstName }}, {{ $inviterName }} has invited you to join {{ config('app.name') }} as an administrator.
                                Use the code below on the "Set your admin password" screen to accept the invite and choose your password.
                            </p>
                            ...
                            <p style="margin: 24px 0 0; font-size: 13px; line-height: 20px; color: #6b7280;">
                                This code expires in {{ $expiresInMinutes }} minutes. If you weren't expecting this invitation, you can ignore this email.
                            </p>
                        </td>
                    </tr>
